...
#define RF_SPI_CSN_3                    // Default CSn position
#define RF_GDO0_2                       // Default GDO0 position
...
#define PROTOCOL_FRAME_MAX_PAYLOAD_LENGTH  10   // Maximum frame payload length
